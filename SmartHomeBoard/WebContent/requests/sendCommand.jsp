...
<%	
	...
	WebTarget target = client
			.target(UriBuilder
					.fromUri(
							"http://localhost:8080/SmartHomeBoard/service/device/sendCommand")
					.build());
	Object obj = target
			.request()
	...
	//JSONObject devices = (JSONObject) parser.parse(obj.toString());
	String redirectURL = "http://localhost:8080/SmartHomeBoard/DevicePage.jsp?deviceID="+deviceID;
